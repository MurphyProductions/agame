...
$.Enemy = function( opt ) {
	...
	this.fillStyle ='hsla(' + this.hue + ', ' + this.saturation + '%, ' + this.lightness + '%, 0)';
...
$.Enemy.prototype.renderHealth = function( i ) {
	if( this.inView && this.life > 0 && this.life < this.lifeMax ) {
		...
		$.ctxmg.fillRect( this.x - this.radius, this.y - this.radius - 6, ( this.radius * 1 ) * ( this.life / this.lifeMax ), 3 );
	}
};
